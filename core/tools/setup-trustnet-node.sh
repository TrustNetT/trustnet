...
VM_USERNAME="warden"
VM_ROOT_PASSWORD="$(openssl rand -base64 12)"  # Random password for root console access
...
export VM_HOSTNAME VM_USERNAME VM_ROOT_PASSWORD SSH_KEY_NAME SSH_KEY_PATH SSH_PRIV_KEY SSH_PUB_KEY
